...
const WORKER_NAME = 'reportWorker';
const WORKER_TYPE = 'generate-report';
...
// ── Simulate generating a report (4s work) ───────────────
async function simulateGenerateReport(payload) {
  await new Promise((resolve) => setTimeout(resolve, 4000));
  return {
    generated: true,
    reportType: payload.reportType || 'monthly-summary',
